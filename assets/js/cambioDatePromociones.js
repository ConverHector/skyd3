const cambiosPorOferta = [
    {
        ...
        silver: {
            ...
            textPromo: `
                <p >Obtén 2X1
                + Descuento Adicional* al contratar con 2 equipos*</p>
            `
        },
        gold: {
            active: true,
            textPromo: `
                <p>Obtén 2X1 + Descuento Adicional* al contratar con 2 equipos*</p>
            `
        },
        platinum: {
            active: false,
...

    {
        ...
        gold: {
            ...
            textPromo: `
                <p>Obtén
                3 meses
                de programación de Sky Platinum</p>
            `
        },
        platinum: {
            active: false,
...

    {
        ...
        platinum: {
            ...
            textPromo: `
                <p >Obtén
                el Paquete Ultra
                a precio especial x 12 meses</p>  
            `
        },
...
const legales = document.querySelector('.terms-conditions')
...
const todayIs = `${monthToday} ${todayDateNumber}`
...
function changeOfertasCards(elementCard, info){
    ...
    const selectorPromoBottomCard = 
        document.querySelector(`[data-plan="${whoPromoCardChanges}"] .extraInfo__promocion`)
